...
const PROJECTS = [
  {
    ...
    title: 'Job Market Trends and Salary Analysis in India',
    sub: 'Power BI Dashboard',
    tag: 'Data Vizualization · Data Analysis · DashBoard',
    hoverBg: 'rgba(120,80,10,0.12)',
    desc: 'Designed and developed an interactive Power BI dashboard to analyze job demand, salary distribution, and employment trends across multiple Indian cities using real-world job market data.',
    bullets: [
      'Performed data cleaning, preprocessing, and aggregation to evaluate salary patterns by experience level, company, and job role, and demand index by city',
      'Implemented advanced visualizations including treemaps, line charts, bar charts, KPI cards, and slicers',
      'Derived actionable insights on high-paying roles, metro-city employment hubs, and remote vs office-based job trends',
    ],
    tech: ['Power BI', 'Data Visualization', 'Business Intelligence', 'Data Analysis'],
    github: 'https://app.powerbi.com/groups/me/reports/43bf04fc-71ec-4153-90fe-4b9cc7ffc6aa?experience=power-bi',
  },
  {
    num: '02', year: 'Oct 2025',
    title: 'Weather Prediction System',
    sub: 'Machine Learning-Based Weather Forecasting',
    tag: 'ML · Python',
    hoverBg: 'rgba(40,40,60,0.25)',
    desc: 'A machine learning-based weather prediction system that analyzes historical atmospheric data to forecast future weather conditions. The model is trained on key features like temperature, humidity, and pressure to deliver accurate and data-driven predictions.',
    bullets: [
      'Built and trained ML models using historical weather datasets for accurate forecasting',
     'Performed data preprocessing, feature engineering, and visualization for better model performance',
     'Achieved reliable predictions using algorithms like Linear Regression / Decision Trees (or whatever you used)',
    ],
    tech: ['Python','Machine Learning','Pandas','NumPy','Scikit-learn','Matplotlib','Seaborn'],
